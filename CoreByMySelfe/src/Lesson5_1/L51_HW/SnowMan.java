...
public class SnowMan {
    ...
    void  drawCircle (Pane frontRoot, Stage primaryStage){
        ...
        double y = primaryStage.getHeight() - 50 - radius;
        double strokeWhide = 2;
        Line line = new Line(50, (primaryStage.getHeight() - 50), 600, (primaryStage.getHeight() - 50) );

        Circle circle = new Circle(x, y, radius);
        circle.setStrokeWidth(strokeWhide);
        circle.setFill(Paint.valueOf("#FFFFFF"));
        circle.setStroke(Paint.valueOf("#000000"));
        frontRoot.getChildren().addAll( circle, line);
    }
